  ...
  const renderLinksByRole = () => {
    ...
    switch (user.role) {
      case 'admin':
        return (
          <>
            <Link href="/admin/dashboard" className="text-foreground/80 hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">
              Admin Dashboard
            </Link>
            <Link href="/admin/advocates" className="text-foreground/80 hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">
              Manage Advocates
            </Link>
          </>
        )
      case 'advocate':
        return (
          <>
            <Link href="/advocate/dashboard" className="text-foreground/80 hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">
              Advocate Dashboard
            </Link>
      ...
      case 'user':
        return (
          <>
            <Link href="/users/dashboard" className="text-foreground/80 hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">
              Dashboard
            </Link>
