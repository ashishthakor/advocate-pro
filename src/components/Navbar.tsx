...
export function Navbar() {
  ...
  if (loading) {
    ...
    return (
      <nav className="h-16 flex items-center justify-center border-b">
        Loading...
      </nav>
    );
  }
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link
                  href="/users/register"
                  className="inline-flex items-center rounded-md text-sm font-medium px-4 py-2 text-white bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 shadow-sm transition-colors"
                >
                  Join as Client
                </Link>
                <Link
                  href="/advocate/register"
                  className="inline-flex items-center rounded-md text-sm font-medium px-4 py-2 text-foreground bg-muted hover:bg-muted/80 border border-border transition-colors"
                >
                  Join as Advocate
                </Link>
              </div>
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <button
              ...
              className={`relative text-foreground/80 hover:text-foreground focus:outline-none p-2 rounded-md ring-1 ring-transparent hover:ring-border transition ${
                isMenuOpen ? "bg-muted" : ""
              }`}
            >
              <svg
