            ...
            <Box sx={{ textAlign: 'center', py: 4 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                {searchTerm || noticeNumberFilter
                  ...
                  : 'You don\'t have any notices for your assigned cases yet.'}
              </Typography>
            </Box>
          </CardContent>
        </Card>
            ...
            <Card key={caseData.id} sx={{ mb: 3 }}>
              <CardContent>
                ...
                <NoticesSection
                  ...
                  onAddNotice={() => router.push(`/advocate/cases?case_id=${caseData.id}&action=create_notice`)}
                  onEditNotice={(notice) => router.push(`/advocate/notices?notice_id=${notice.id}&action=edit`)}
